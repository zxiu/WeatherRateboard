package com.rateboard.weather.validator;
...
public class ResponseValidator {
	...
	public static boolean validWeather10Days(String result) {
		if (result == null) {
			return false;
		}
		Map response;
		try {
			response = JsonPath.read(result, "$.response");
		} catch (Exception e) {
			return false;
		}
		if (response.get("error") != null || response.get("features") == null) {
			return false;
		}
		...
		boolean valid = features.get("forecast10day").equals(1);
